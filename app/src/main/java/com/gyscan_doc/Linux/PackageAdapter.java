...
public class PackageAdapter extends RecyclerView.Adapter<PackageAdapter.ViewHolder> {
    ...
    private Consumer<CommandPackage> onPackageClick;

    public PackageAdapter(List<CommandPackage> packages, Consumer<CommandPackage> onPackageClick) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        CommandPackage pkg = packages.get(position);
